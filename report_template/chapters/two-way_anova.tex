...
\subsubsection*{1. Ảnh hưởng của hãng}
\begin{itemize}
...
\subsubsection*{2. Ảnh hưởng của loại GPU}
\begin{itemize}
...
\subsubsection*{3. Tác động tương tác giữa hai yếu tố}
\begin{itemize}
...
% ==========================================================
\subsection{Các giả định của ANOVA hai yếu tố}
ANOVA hai yếu tố yêu cầu ba giả định chính:

\subsubsection*{1. Phần dư tuân theo phân phối chuẩn}
\begin{itemize}
...
\subsubsection*{2. Phương sai giữa các nhóm là đồng nhất}
\begin{itemize}
...
\subsubsection*{3. Các quan sát độc lập}
\begin{itemize}
...
% ==========================================================
\subsection{Cơ sở toán học của ANOVA hai yếu tố}

\subsubsection*{Mô hình ANOVA hai yếu tố}
...
\subsubsection*{Ý nghĩa của các thành phần trong mô hình}
...
\subsubsection*{Phân rã tổng biến thiên}
...
\subsubsection*{Tính toán F-statistic}
...
% ==========================================================
\subsection{Quy trình thực hiện ANOVA hai yếu tố}
...
\subsubsection*{Bước 2: Kiểm tra cấu trúc dữ liệu}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=10cm]{Images/basicstats.png}
    \end{center}
...
\subsubsection*{Bước 3: Xây dựng mô hình ANOVA hai yếu tố}
\[
...
\subsubsection*{Bước 4: Kiểm định giả định}
...
\paragraph*{Kết luận về giả định:}
\begin{itemize}
...
\subsubsection*{Bước 5: Kiểm định hậu nghiệm}
Sử dụng lệnh:
\begin{verbatim}
...
\subsubsection*{Bước 6: Vẽ đồ thị}
