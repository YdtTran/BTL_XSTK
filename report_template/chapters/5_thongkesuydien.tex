...
\begin{itemize}
    \item \textbf{Bước 1:} Chia dữ liệu thành 2 nhóm và tính các đặc điểm thống kê mẫu cho từng nhóm.
...
print(bang_ket_qua)
          ...
          \begin{figure}[H]
              \centering
              \includegraphics[width=0.5\textwidth]{graphics/5_1table.png}
...
\end{lstlisting}
    \item \underline{\textbf{Kết quả sau khi chạy trên R:}}
          \begin{figure} [H]
              \centering
              \includegraphics[width=0.7\textwidth]{graphics/KQ1.png}
    ...
    \item \textbf{Tính tuyến tính.}
          ...
          {Ta dùng mô hình chẩn đoán Residuals-Fitted để kiểm tra bằng lệnh:
            ...
            \end{lstlisting}
              ...
              \begin{figure} [H]
                  \centering
                  \includegraphics[width=0.6\textwidth]{graphics/ResidualsvsFitted.png}
...
plot(model, which=2) 
              ...
              \begin{figure} [H]
                  \centering
                  \includegraphics[width=0.6\textwidth]{graphics/Q_Q.png}
                  \caption{Biểu đồ Q-Q}
                  \label{fig:mh2_hqtt}
              \end{figure}
...
plot(model, which=3) # Scale-Location
          ...
          \begin{figure} [H]
              \centering
              \includegraphics[width=0.6\textwidth]{graphics/Scale_Location.png}
