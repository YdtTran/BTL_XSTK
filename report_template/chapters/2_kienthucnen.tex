...
\[ \mu = \dfrac{1}{N} \sum_{i=1}^{N} X_i = \dfrac{X_1 + X_2 + \dots + X_N}{N} \]
...
\[ \bar{x} = \dfrac{1}{n}\displaystyle\sum_{i=1}^{k} x_i n_i = \dfrac{x_1 n_1 + x_2 n_2 + \dots + x_k n_k}{n} \]
...
\[ s^2 = \dfrac{1}{n-1} \sum_{i=1}^{k} n_i (x_i - \bar{x})^2\]
...
\[ CV(\text{tongthe}) = \dfrac{\sigma}{\mu} \times 100\% \]
\[ CV(\text{mau}) = \dfrac{s}{\bar{x}} \times 100\% \]
...
% \[ SE(\text{tongthe}) = \dfrac{\sigma}{\sqrt{N}} \]
% \[ SE(\text{mau}) = \dfrac{s}{\sqrt{n}} \]
...
%         \multirow{3}{*}{Tỷ lệ}                                                                                              & \multirow{3}{*}{$n \ge 30$}                              & Đối xứng                                                        & $\displaystyle \epsilon = z_{\alpha/2} \sqrt{\dfrac{f(1-f)}{n}}$              & $\displaystyle f - \epsilon < p < f + \epsilon$                              \\ \cline{3-5}
%                                                                                                                             &                                                          & Bên phải                                                        & $\displaystyle \epsilon = z_{\alpha} \sqrt{\dfrac{f(1-f)}{n}}$                & $\displaystyle 0 < p < f + z_{\alpha} \sqrt{\dfrac{f(1-f)}{n}}$               \\ \cline{3-5}
%                                                                                                                             &                                                          & Bên trái                                                        & $\displaystyle \epsilon = z_{\alpha} \sqrt{\dfrac{f(1-f)}{n}}$                & $\displaystyle f - z_{\alpha} \sqrt{\dfrac{f(1-f)}{n}} < p < 1$               \\ \hline
%         \multirow{6}{*}{Trung bình}                                                                                         & \multirow{3}{*}{\parbox{3.5cm}{$X \sim N(\mu, \sigma^2)$                                                                                                                                                                                                                                 \\ Đã biết $\sigma$}} & Đối xứng & $\displaystyle \epsilon = z_{\alpha/2} \dfrac{\sigma}{\sqrt{n}}$ & $\displaystyle \bar{x} - \epsilon < \mu < \bar{x} + \epsilon$ \\ \cline{3-5}
%                                                                                                                             &                                                          & Bên phải                                                        & $\displaystyle \epsilon = z_{\alpha} \dfrac{\sigma}{\sqrt{n}}$                & $\displaystyle -\infty < \mu < \bar{x} + z_{\alpha} \dfrac{\sigma}{\sqrt{n}}$ \\ \cline{3-5}
%                                                                                                                             &                                                          & Bên trái                                                        & $\displaystyle \epsilon = z_{\alpha} \dfrac{\sigma}{\sqrt{n}}$                & $\displaystyle \bar{x} - z_{\alpha} \dfrac{\sigma}{\sqrt{n}} < \mu < \infty$  \\ \cline{2-5}
%                                                                                                                             & \multirow{3}{*}{\parbox{3.5cm}{$X \sim N(\mu, \sigma^2)$                                                                                                                                                                                                                                 \\ Chưa biết $\sigma$}} & Đối xứng & $\displaystyle \epsilon = t_{\alpha/2; n-1} \dfrac{s}{\sqrt{n}}$ & $\displaystyle \bar{x} - \epsilon < \mu < \bar{x} + \epsilon$ \\ \cline{3-5}
%                                                                                                                             &                                                          & Bên phải                                                        & $\displaystyle \epsilon = t_{\alpha; n-1} \dfrac{s}{\sqrt{n}}$                & $\displaystyle -\infty < \mu < \bar{x} + t_{\alpha; n-1} \dfrac{s}{\sqrt{n}}$ \\ \cline{3-5}
%                                                                                                                             &                                                          & Bên trái                                                        & $\displaystyle \epsilon = t_{\alpha; n-1} \dfrac{s}{\sqrt{n}}$                & $\displaystyle \bar{x} - t_{\alpha; n-1} \dfrac{s}{\sqrt{n}} < \mu < \infty$  \\ \hline
%         \multicolumn{2}{|l|}{\parbox{5cm}{Phân phối tùy ý, mẫu lớn ($n \ge 30$). Nếu chưa biết $\sigma$ thì thay bằng $s$}} & Đối xứng                                                 & $\displaystyle \epsilon = z_{\alpha/2} \dfrac{\sigma}{\sqrt{n}}$ & $\displaystyle \bar{x} - \epsilon < \mu < \bar{x} + \epsilon$                                                                                               \\ \cline{3-5}
%         \multicolumn{2}{|l|}{}                                                                                              & Bên phải                                                 & $\displaystyle \epsilon = z_{\alpha} \dfrac{\sigma}{\sqrt{n}}$   & $\displaystyle -\infty < \mu < \bar{x} + z_{\alpha} \dfrac{\sigma}{\sqrt{n}}$                                                                                \\ \cline{3-5}
%         \multicolumn{2}{|l|}{}                                                                                              & Bên trái                                                 & $\displaystyle \epsilon = z_{\alpha} \dfrac{\sigma}{\sqrt{n}}$   & $\displaystyle \bar{x} - z_{\alpha} \dfrac{\sigma}{\sqrt{n}} < \mu < \infty$                                                                                 \\ \hline
%     \end{tabular}
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{|p{1.5cm}|p{3.5cm}|c|c|p{5.5cm}|c|}
            ...
            \multirow{3}{*}{\parbox{1.5cm}{\textbf{Kiểm định tỷ lệ 1 mẫu}}}
                              ...
                              & \multirow{3}{*}{$\displaystyle Z_{qs} = \dfrac{f - p_0}{\sqrt{\dfrac{p_0(1-p_0)}{n}}} \approx N(0,1)$}                                                                                                                                                                                                                                                                             \\
            \cline{4-5}
            ...
            % --- Trường hợp 2a ---
                              ...
                              & \multirow{3}{*}{$\displaystyle Z_{qs} = \dfrac{\bar{X} - \mu_0}{\dfrac{\sigma}{\sqrt{n}}} \sim N(0,1)$}                                                                                                                                                                                                                                                                            \\
            \cline{4-5}
            ...
            % --- Trường hợp 2b ---
                              ...
                              & \multirow{3}{*}{$\displaystyle T_{qs} = \dfrac{\bar{X} - \mu_0}{\dfrac{s}{\sqrt{n}}} \sim T_{(n-1)}$}                                                                                                                                                                                                                                                                              \\
            \cline{4-5}
            ...
            % --- Trường hợp 2c ---
                              ...
                              & \multirow{3}{*}{$\mu = \mu_0$}
                              & $\mu \neq \mu_0$                                                                                                                  & $(-\infty; -z_{\alpha/2}) \cup (z_{\alpha/2}; +\infty)$
                              & \multirow{3}{*}{\parbox{4cm}{\centering $\displaystyle Z_{qs} = \dfrac{\bar{X} - \mu_0}{\dfrac{\sigma}{\sqrt{n}}} \approx N(0,1)$                                                                                                                                                                                                                                                  \\ \footnotesize Nếu chưa biết $\sigma$ thì thay bởi $s$}} \\
            \cline{4-5}
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{|p{5.5cm}|c|c|c|c|}
            ...
            \multirow{3}{*}{\parbox{5.5cm}{* 2 mẫu độc lập                                                                                                                                                                                                                                                                 \\ * $X_1, X_2$ có pp chuẩn. \\ * Đã biết $\sigma_1^2$ và $\sigma_2^2$ \hfill (4a)}}
                                          ...
                                          & \multirow{3}{*}{$\displaystyle Z_{qs} = \dfrac{\bar{X}_1 - \bar{X}_2}{\sqrt{\dfrac{\sigma_1^2}{n_1} + \dfrac{\sigma_2^2}{n_2}}}$}                                                                                                                                              \\
            \cline{3-4}
            ...
            \multirow{3}{*}{\parbox{5.5cm}{* 2 mẫu độc lập                                                                                                                                                                                                                                                                 \\ * $X_1, X_2$ có pp chuẩn \\ * Chưa biết $\sigma_1^2; \sigma_2^2$; $\sigma_1^2 = \sigma_2^2$ \hfill (4b)}}
                                          ...
                                          & \multirow{3}{*}{$\displaystyle T_{qs} = \dfrac{\bar{X}_1 - \bar{X}_2}{\sqrt{s_p^2 \left(\dfrac{1}{n_1} + \dfrac{1}{n_2}\right)}}$}                                                                                                                                             \\
            \cline{3-4}
            ...
            \multirow{3}{*}{\parbox{5.5cm}{* 2 mẫu độc lập                                                                                                                                                                                                                                                                 \\ * $X_1, X_2$ có pp chuẩn \\ * Chưa biết $\sigma_1^2, \sigma_2^2$; $\sigma_1^2 \neq \sigma_2^2$ \hfill (4c)}}
                                          ...
                                          & \multirow{3}{*}{$\displaystyle T_{qs} = \dfrac{\bar{X}_1 - \bar{X}_2}{\sqrt{\dfrac{s_1^2}{n_1} + \dfrac{s_2^2}{n_2}}}$}                                                                                                                                                        \\
            \cline{3-4}
            ...
            \multirow{3}{*}{\parbox{5.5cm}{* 2 mẫu phụ thuộc                                                                                                                                                                                                                                                               \\ tương ứng theo cặp \\ * $X_1, X_2$ có pp chuẩn \\ * Chưa biết $\sigma_D^2$ \hfill (4e)}}
                                          ...
                                          & \multirow{3}{*}{$\displaystyle T_{qs} = \dfrac{\bar{X}_D - \mu_0}{s_D} \sqrt{n}$}                                                                                                                                                                                              \\
            \cline{3-4}
            ...
            \multirow{3}{*}{\parbox{5.5cm}{* 2 mẫu phụ thuộc                                                                                                                                                                                                                                                               \\ tương ứng theo cặp \\ * 2 mẫu lớn: $n \ge 30$ \\ * Đã biết hoặc chưa biết $\sigma_D^2$ \hfill (4f)}}
                                          & \multirow{3}{*}{$\mu_1 = \mu_2$}
                                          & $\mu_1 \neq \mu_2$                                                                                                                 & $(-\infty; -z_{\alpha/2}) \cup (z_{\alpha/2}; +\infty)$
                                          & \multirow{3}{*}{$\displaystyle Z_{qs} = \dfrac{\bar{X}_D - \mu_0}{\sigma_D} \sqrt{n}$}                                                                                                                                                                                         \\
            \cline{3-4}
                                          &                                                                                                                                    & $\mu_1 < \mu_2$                                                       & $(-\infty; -z_{\alpha})$             &                            \\
            \cline{3-4}
                                          &                                                                                                                                    & $\mu_1 > \mu_2$                                                       & $(z_{\alpha}; +\infty)$              &                            \\
...
\[ \bar{x}_i = \dfrac{\sum_{j=1}^{n_i} x_{ij}}{n_i}, \quad (i = 1, 2, \dots, k) \]
...
\[ MSW = \dfrac{SSW}{N - k}, \quad MSB = \dfrac{SSB}{k - 1} \]
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|}
        ...
        Giữa các nhóm                    & SSB         & k-1         & MSB         & \multirow{2}{*}{$\displaystyle F = \dfrac{MSB}{MSW}$} \\ \cline{1-4}
...
\subsubsection{Một số dạng kiểm định}

% ==================================================================
% MỤC 6.2.1
% ==================================================================
\begin{itemize}
    \item \textbf{Kiểm định hệ số chặn $\beta_0$}
    \item
          \noindent \textbf{1. Đặt giả thuyết và xác định miền bác bỏ tương ứng (sử dụng một trong hai cách viết miền bác bỏ):}
          \begin{table}[H]
              \centering
              \renewcommand{\arraystretch}{1.5} % Tăng chiều cao dòng cho dễ đọc
              \begin{tabular}{|c|c|c|}
                  \hline
                  \textbf{Giả thiết}                                        & \textbf{Miền bác bỏ (1)}                                                 & \textbf{Miền bác bỏ (2)}     \\ \hline
                  $H_0: \beta_0 = \beta_{0'}; H_1: \beta_0 \neq \beta_{0'}$ & $RR = (-\infty; -t_{\alpha/2}^{n-2}) \cup (t_{\alpha/2}^{n-2}; +\infty)$ & $|t_0| > t_{\alpha/2}^{n-2}$ \\ \hline
                  $H_0: \beta_0 = \beta_{0'}; H_1: \beta_0 < \beta_{0'}$    & $RR = (-\infty; -t_{\alpha}^{n-2})$                                      & $t_0 < -t_{\alpha}^{n-2}$    \\ \hline
                  $H_0: \beta_0 = \beta_{0'}; H_1: \beta_0 > \beta_{0'}$    & $RR = (t_{\alpha}^{n-2}; +\infty)$                                       & $t_0 > t_{\alpha}^{n-2}$     \\ \hline
              \end{tabular}
          \end{table}

          \noindent Thông thường $\beta_{0'} = 0$.

          \noindent \textbf{2. Tính thống kê kiểm định:}
          \[
              t_0 = \dfrac{\hat{\beta}_0 - \beta_{0'}}{\dfrac{s\sqrt{\overline{x^2}}}{\sqrt{S_{xx}}}}
          \]
    \item \textbf{Kiểm định hệ số góc $\beta_1$}
          ...
          \begin{table}[H]
              ...
              \begin{tabular}{|c|c|c|}
                  \hline
                  \textbf{Giả thiết}                                        & \textbf{Miền bác bỏ (1)}                                                 & \textbf{Miền bác bỏ (2)}     \\ \hline
                  $H_0: \beta_1 = \beta_{1'}; H_1: \beta_1 \neq \beta_{1'}$ & $RR = (-\infty; -t_{\alpha/2}^{n-2}) \cup (t_{\alpha/2}^{n-2}; +\infty)$ & $|t_0| > t_{\alpha/2}^{n-2}$ \\ \hline
                  $H_0: \beta_1 = \beta_{1'}; H_1: \beta_1 < \beta_{1'}$    & $RR = (-\infty; -t_{\alpha}^{n-2})$                                      & $t_0 < -t_{\alpha}^{n-2}$    \\ \hline
                  $H_0: \beta_1 = \beta_{1'}; H_1: \beta_1 > \beta_{1'}$    & $RR = (t_{\alpha}^{n-2}; +\infty)$                                       & $t_0 > t_{\alpha}^{n-2}$     \\ \hline
              \end{tabular}
          \end{table}

          \noindent Thông thường $\beta_{1'} = 0$.

          \noindent \textbf{2. Tính thống kê kiểm định:}
          \[
              t_0 = \dfrac{\hat{\beta}_1 - \beta_{1'}}{\dfrac{s}{\sqrt{S_{xx}}}}
          \]
    \item \textbf{Kiểm định sự phù hợp của đường hồi quy}

          \noindent \textbf{1. Đặt giả thuyết:}
          \begin{itemize}
              \item $H_0: R^2 = 0$ hoặc $(\beta_1 = 0)$: Phương trình đường hồi quy không thích hợp.
              \item $H_1: R^2 \neq 0$ hoặc $(\beta_1 \neq 0)$: Phương trình đường hồi quy thích hợp.
          \end{itemize}

          \noindent \textbf{2. Miền bác bỏ:}
          \[ RR = (F_{\alpha}^{1; n-2}; +\infty) \quad \text{hoặc} \quad F > F_{\alpha}^{1; n-2} \]

          \noindent \textbf{3. Tính thống kê kiểm định:}
          \[
              F = \dfrac{R^2}{\dfrac{1 - R^2}{n - 2}}
          \]
    \item \textbf{Kiểm định mối tương quan tuyến tính}

          \noindent \textbf{1. Đặt giả thuyết:}
          \begin{itemize}
              \item $H_0: \rho_{XY} = 0$: X, Y không có tương quan tuyến tính.
...
% MỤC 6.2.2
% ==================================================================
% Lưu ý: Trong ảnh gốc tiêu đề ghi là "hệ số chặn beta 1" (có thể là lỗi typo của slide), mình sửa thành "hệ số góc" cho đúng toán học.
